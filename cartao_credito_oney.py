...
PAGAR_CARTAO_CREDITO = "2a1fdc291a7280dcb7e2cd8a1bb468ae"

# === IDs DAS CONTAS ===
CARTAO_ONEY = "2a1fdc291a72807daabaf0e43515ce78"
...
if pago is True:
    ...
    notion.pages.create(
        ...
        properties={
            P_NOME: {
                "title": [
                    {"text": {"content": "Pagamento do Cartão de Crédito Oney"}}
                ]
            },
            P_CATEGORIA: {
                "relation": [
